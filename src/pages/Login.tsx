...
export default function Login() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setError(null);
    try {
      await dataService.login(password);
      ...
      <div className="w-full max-w-sm">
        ...
        <TacticalPanel className="p-6">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="font-display font-bold text-white uppercase tracking-wide-ds text-sm">Admin Access</h1>
              <p className="font-mono text-[10px] text-suncoast-warm-gray uppercase tracking-widest mt-0.5">Enter the admin password</p>
            </div>
          </div>
